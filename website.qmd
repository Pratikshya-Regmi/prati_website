...
2. Make sure you have Quarto installed. If not, download it from [Quarto's website](https://quarto.org/docs/get-started/)
...
5. Open the generated `website.html` file in your web browser
